************************
Nengo Benchmarks license
************************

The Nengo Benchmarks are made available under a proprietary license that permits
using, copying, sharing, and making derivative works
from Nengo Benchmarks and its source code for any non-commercial purpose.

If you would like to use Nengo Benchmarks commercially, licenses can be
...
Nengo Benchmarks Individual Contributor Assignment Agreement
============================================================

Thank you for your interest in contributing to Nengo Benchmarks, a product of
...
<https://github.com/nengo/nengo-benchmarks/blob/master/CONTRIBUTORS.rst>
